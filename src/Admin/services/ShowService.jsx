              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Description (KH / EN / CH)</th>
                  ...
                  {loading ? (
                    ...
                    services.map((item, index) => (
                      <tr className="hover:bg-gray-50 transition-colors" key={item._id}>
                        ...
                        <td className="px-6 py-4 text-sm">
                          <div className="font-bold text-gray-900">{item.description?.kh}</div>
                          <div className="text-gray-500 italic text-xs">{item.description?.en}</div>
                          <div className="text-gray-500 italic text-xs">{item.description?.ch}</div>
                        </td>
                    ...
                    <tr>
                      <td colSpan="7" className="px-6 py-10 text-center text-gray-400">No services found.</td>
                    </tr>
                  )}
                </tbody>
              </table>
